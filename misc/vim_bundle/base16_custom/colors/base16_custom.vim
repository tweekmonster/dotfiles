...
call <sid>hi("SpecialKey",    s:p.gui03, "", s:p.cterm03, "", "")
...
call <sid>hi("Conceal",       s:p.gui02, s:p.gui00, s:p.cterm02, s:p.cterm00, "")
call <sid>hi("Cursor",        s:p.gui00, s:p.gui05, s:p.cterm00, s:p.cterm05, "")
call <sid>hi("NonText",       s:p.gui02, "", s:p.cterm02, "", "")
call <sid>hi("Normal",        s:p.gui05, s:p.gui00, s:p.cterm05, s:p.cterm00, "")
call <sid>hi("LineNr",        s:p.gui03, s:p.gui01, s:p.cterm03, s:p.cterm01, "")
...
call <sid>hi("ColorColumn",   "", s:p.gui01, "", s:p.cterm01, "")
call <sid>hi("CursorColumn",  "", s:p.gui01, "", s:p.cterm01, "none")
call <sid>hi("CursorLine",    "", s:p.gui01, "", s:p.cterm01, "none")
call <sid>hi("CursorLineNr",  s:p.gui0A, s:p.gui01, s:p.cterm0A, s:p.cterm01, "")
...
call <sid>hi("GitGutterAdd",     s:p.gui0B, s:p.gui01, s:p.cterm0B, s:p.cterm01, "")
call <sid>hi("GitGutterChange",  s:p.gui0D, s:p.gui01, s:p.cterm0D, s:p.cterm01, "")
call <sid>hi("GitGutterDelete",  s:p.gui08, s:p.gui01, s:p.cterm08, s:p.cterm01, "")
call <sid>hi("GitGutterChangeDelete",  s:p.gui0E, s:p.gui01, s:p.cterm0E, s:p.cterm01, "")
...
call <sid>hi("SpellBad",     "", s:p.gui00, "", s:p.cterm00, "undercurl")
call <sid>hi("SpellLocal",   "", s:p.gui00, "", s:p.cterm00, "undercurl")
call <sid>hi("SpellCap",     "", s:p.gui00, "", s:p.cterm00, "undercurl")
call <sid>hi("SpellRare",    "", s:p.gui00, "", s:p.cterm00, "undercurl")
